...
$vendor = $_SESSION['vendor'];
 ...
 include 'config.php';
 $custD = mysqli_query($link,"SELECT * FROM `user_booking` WHERE `bookid` = '$bookid'");
...
$message="<html>
            ...
            <div style='padding:50px;'>
                <p>Dear $custName,<br>
                  <p>Upadated your travel information for booking id $bookingId. Please see the updated trip details below. </p>
                         ...
                         <strong>Vahicle Number - $vNumber </strong><br>
...
//mail to customer
if($tripType == 'Round' || $tripType == 'round'){
$to = $custMail;
$subject = "Your journey information has been updated.";
...
alert("Mail Sent !");
window.location.href = "client-details.php";
</script>