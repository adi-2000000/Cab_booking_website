...
<body>
        ...
        <div class="animated">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <strong class="card-title" v-if="headerText">Booking Details</strong>
                </div>
                <div class="card-body">
            ...
            <div class="container">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="mediumModalLabel" style="text-align:center;"><strong>Assign Vendor</strong></h3>
                                      ...
                                      include 'config.php';
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="assign-vendor.php" method="POST">
                ...
                <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content" style="width: 120%;">
                            <div class="modal-header">
                                <h3 class="modal-title" id="largeModalLabel" style="text-align:center;"><strong>Assign Driver</strong></h3>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                ...
                <div class="modal fade" id="largeModal2" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel2"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="largeModalLabel" style="text-align:center;"><strong>Assign Cab</strong></h3>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                       ...
                                       ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="assign-cab.php" method="POST">
                                                        <input type="hidden" name="bookid"
                                                            value="<?php echo $bookid ?>">
            ...
            <div class="card mb-5">
                ...
                <div class="modal fade" id="largeModal6" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel6"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="largeModalLabel">Client's Booking Details</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#largeModal6"
        style="width:150px; height:40px; margin:10px">Show Details</button>
    <?php if($status == '0' || $status == '1' ) { ?>
      <a href="booking-complete.php">
            <button type="button" class="btn btn-info" style="width:150px; height:40px; margin:10px">Trip Complete</button>
        </a>
        
       
       <a href="send-update-mail.php">
            <button type="button" class="btn btn-success" style="width:150px; height:40px; margin:10px">Send Mail</button>
        </a>
        <a href="cancel-booking.php">
            <button type="button"  style="width:150px; height:40px; margin:10px"   class="btn btn-danger"  data-dismiss="modal">Cancel</button>
        </a>
    <?php } ?>
...
<!--</div>-->
                ...
                <div class="col-md-3">
                    ...
                    <? if($status == '0' || $status == '1' ){ ?>
                    <a href="cancel-vendor.php"><button type="button" class="btn btn-danger pull-right"
                ...
                <div class="col-md-3">
                    ...
                    <? if($status == '0' || $status == '1' ){ ?>
                    <a href="cancel-driver.php"><button type="button" class="btn btn-danger pull-right"
                ...
                <div class="col-md-3">
                    ...
                    <? if($status == '0' || $status == '1' ){ ?>
                    <a href="cancel-cab.php"><button type="button" class="btn btn-danger pull-right"
