            ...
            <div class="animated fadeIn">
              <div class="col-md-12">
                 <div class="card">
                        ...
                        <h3 class="text-center p-2"><strong>&nbsp;|&nbsp; New Special Offers &nbsp;|&nbsp; Update &nbsp;|&nbsp;</strong> <label class="text-danger">&nbsp; </label></h3> 
                        </div>
...
<form id="form" action="booking-details.php" Method="POST">
    ...
    <p>6+1 seater</p>
                         ...
                         <h3 class="text-dark my-1 "><strong>OFFER's Timing | Limitations</strong></h3><br>
                             ...
                             <div class="col-md-6">
                              ...
                              <form id="contact" action="" method="post">
                                     <h3 class="text-dark my-1 text-center"><strong>OFFERS</strong></h3> 
                                <fieldset>
