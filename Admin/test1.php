            ...
            <div class="animated">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong class="card-title" v-if="headerText"><i class="mr-2 fa fa-align-justify"></i>Booking Details</strong>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
                      ...
                      <button type="button" class="btn btn-warning mb-1" data-toggle="modal" data-target="#largeModal1">
                          Assign Cab
                      </button>
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="largeModalLabel">Assign Driver</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                                  <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                      include 'config.php';
                                       $pic = mysqli_query($link,"SELECT * FROM `driver_details` WHERE status='1' AND vendorid = '$vendorid' ORDER BY `id` DESC");
            ...
            <div class="modal fade" id="largeModal1" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="largeModalLabel">Assign Cab</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                                ...
                                <table id="myTable3"
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                      include 'config.php';
                                       $pic = mysqli_query($link,"SELECT * FROM `cabs_details` WHERE status='1' AND vendorid = '$vendorid' ORDER BY `id` DESC");
                                       while($row = mysqli_fetch_array($pic)){
                                       ?>
                                            <tr>
     ...
     <?php
            ...
            //echo $datetime;
                                ...
                                if($row['time'] <= $datetime && $row['time'] >= $time && $row['date'] == $date)
                                        {
                                          $phone = $row['phone'];
                                        }
                                   ?>
            ...
            //echo $datetime;
                    ...
                    <?php if($status == '0' || $status == '1' ){ ?>
                    <a href="send-update-mail.php"><button type="button" class="btn btn-success"
                            style="width:150px; height:40px;">Send Mail</button></a><br><br>
                    <a href="booking-complete.php"><button type="button" class="btn btn-info"
                            style="width:150px; height:40px;">Trip Complete</button></a>
                    <a href="cancel-trip.php"><button type="button" class="btn btn-danger pull-right"
