...
<body>
       ...
       <div class="drop p-3 text-dark" style="color:white">
       <li class="menu-item-has-children dropdown" style="color:white" >
...
if(isset($_POST['submit_trip'])){
    ...
    $sql = "INSERT INTO `oneway_trip` (source_state, source_city, destination_state,destination_city, hatchback, sedan, suv, suvplus) 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="submit_trip" class="btn btn-info"  style="
    background: #f10303">Submit
                                                Trip</button>
                                        </div>
                                    </div>
