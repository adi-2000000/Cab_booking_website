                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><i class="mr-2 menu-icon fa fa-car"></i>  All Cabs Details</strong>&nbsp;<button class="button btn-add" data-toggle="modal" data-target="#myModal" ><i style="font-size:24px" class="fa" title="Add More">&#xf067;</i></button>
                            </div>
         ...
         <!--<div class="container mt-3">
                            ...
                            <div class="card-body card-block">
                                <form action="cabs-insert.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <!--<div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cab No Plate</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">Add Cab's Image</label></div>
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="cabs.php"><button type="button" class="btn btn-warning" title="Pending Cabs">
                               <?php
                              include 'config.php';
                               $pic = mysqli_query($link,"SELECT COUNT(*) FROM `cabs_details` WHERE status='0'");
                               while($row = mysqli_fetch_array($pic)){
                               ?> 
                            Pending <span class="badge bg-light"><?php echo $row['COUNT(*)']?></span><?php } ?>
                          </button></a>
                         
                          <a href="cabs-approved.php"><button type="button" class="btn btn-success" title="Approved Cabs">Approved<?php 
                              include 'config.php';
                               $pic = mysqli_query($link,"SELECT COUNT(*) FROM `cabs_details` WHERE status='1'");
                               while($row = mysqli_fetch_array($pic)){
                               ?> 
                             <span class="badge bg-dark"><?php echo $row['COUNT(*)']?></span> <?php }  ?>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                     <?php
                                      include 'config.php';
                                       $pic = mysqli_query($link,"SELECT * FROM `cabs_details` WHERE status='0' ORDER BY `id` DESC");
                                       while($row = mysqli_fetch_array($pic)){
                                       ?> 
                                        <tr>
