                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-1">
                                     ...
                                     <?php  
                                      include 'config.php';
                                       $op = mysqli_query($link,"SELECT SUM(amount) AS onlineprice FROM user_booking WHERE status = '2' and b2bid = '$b2bid'");
                           ...
                           <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-3">
                                     ...
                                     <?php  
                                      include 'config.php';
                                       $pic = mysqli_query($link,"SELECT COUNT(user_trip_type) FROM `user_booking` WHERE `b2bid`= '0' and `status` ='0'");
                          ...
                          <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-2">
                                      ...
                                      <?php  
                                      include 'config.php';
                                       $pendingon = mysqli_query($link,"SELECT COUNT(*) FROM `user_booking` WHERE status='0' and b2bid = '$b2bid'");
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-6">
                                      ...
                                      <?php  
                                      include 'config.php';
                                       $ongoing = mysqli_query($link,"SELECT COUNT(*) FROM `user_booking` WHERE status='1'  and b2bid = '$b2bid'");
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-9">
                                      ...
                                      <?php  
                                      include 'config.php';
                                       $completed = mysqli_query($link,"SELECT COUNT(*) FROM `user_booking` WHERE status='2' and b2bid = '$b2bid'");
                           ...
                           <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-4">
                                      ...
                                      <?php  
                                      include 'config.php';
                                       $cancelled = mysqli_query($link,"SELECT COUNT(*) FROM `user_booking` WHERE status='3' and b2bid = '$b2bid'");
                                                ...
                                                <div class="stat-widget-one">
                                                    ...
                                                    <div class="stat-content dib">
                                                        <div class="stat-text">One Way</div>
                                                          <?php  
                                                      include 'config.php';
                                                       $onwway = mysqli_query($link,"SELECT COUNT(user_trip_type) FROM `user_booking` WHERE user_trip_type='One Way' and b2bid = '$b2bid'");
                                                ...
                                                <div class="stat-widget-one">
                                                    ...
                                                    <div class="stat-content dib">
                                                        <div class="stat-text">Round Trip</div>
                                                         <?php  
                                                      include 'config.php';
                                                       $round = mysqli_query($link,"SELECT COUNT(user_trip_type) FROM `user_booking` WHERE user_trip_type='Round' and b2bid = '$b2bid'");
                                                ...
                                                <div class="stat-widget-one">
                                                    ...
                                                    <div class="stat-content dib">
                                                        <div class="stat-text">Rental</div>
                                                         <?php  
                                                      include 'config.php';
                                                       $rental = mysqli_query($link,"SELECT COUNT(user_trip_type) FROM `user_booking` WHERE user_trip_type='Rental' and b2bid = '$b2bid'");
                                                           ...
                                                           <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="card-body">
                                                                           <?php  
                                                                          include 'config.php';
                                                                         $pic = mysqli_query($link,"SELECT COUNT(user_trip_type) FROM user_booking WHERE b2bid = '$b2bid'");
                                                                         while($row = mysqli_fetch_array($pic)){
                                                                           ...
                                                                           ?>
                                                                            ...
                                                                            <div class="progress-box progress-1">
                                                                                 <?php  
                                                                          include 'config.php';
                                                                         $pic = mysqli_query($link,"SELECT COUNT(*) FROM user_booking WHERE user_trip_type='One Way' AND b2bid = '$b2bid'");
                                                                         while($row = mysqli_fetch_array($pic)){
                                                                           ?>
                                                                          ...
                                                                          ?>
                                                                            ...
                                                                            <div class="progress-box progress-2">
                                                                                 <?php  
                                                                          include 'config.php';
                                                                         $pic = mysqli_query($link,"SELECT COUNT(*) FROM user_booking WHERE user_trip_type='Round' AND b2bid = '$b2bid'");
                                                                         while($row = mysqli_fetch_array($pic)){
                                                                           ?>
                                                                          ...
                                                                          ?>
                                                                            ...
                                                                            <div class="progress-box progress-2">
                                                                                 <?php  
                                                                          include 'config.php';
                                                                         $pic = mysqli_query($link,"SELECT COUNT(*) FROM user_booking WHERE user_trip_type='Rental' AND b2bid = '$b2bid'");
                                                                         while($row = mysqli_fetch_array($pic)){
                                                                           ?>
