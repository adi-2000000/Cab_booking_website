                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">All Driver Details</strong>&nbsp;<button class="button btn-add" data-toggle="modal" data-target="#myModal" ><i style="font-size:24px" class="fa">&#xf067;</i></button>
                            </div>
         ...
         <!--<div class="container">
                            ...
                            <div class="card-body card-block">
                                <form action="driver-insert.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <!--<div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">Adhaar Card</label></div>
                                        <div class="col-12 col-md-9"><input type="file" id="file-input" name="d-img-doc" class="form-control-file"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">DL No.</label></div>
                                        <div class="col-12 col-md-9"><input type="file" id="file-input" name="d-img-doc2" class="form-control-file"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">PVC No.</label></div>
                                        <div class="col-12 col-md-9"><input type="file" id="file-input" name="d-img-doc3" class="form-control-file"></div>
                                    </div>-->
...
<!------modal----for---add----drivers----->                             
 ...
 <a href="drivers.php"><button type="button" class="btn btn-warning">
    Pending <?php
      include 'config.php';
       $pic = mysqli_query($link,"SELECT COUNT(*) FROM `driver_details` WHERE status='0'");
       while($row = mysqli_fetch_array($pic)){
       ?> <span class="badge bg-light"><?php echo $row['COUNT(*)']?></span>  <?php } ?>
  </button></a>
 
  <button type="button" class="btn btn-success"> 
    Approved <?php 
      include 'config.php';
       $pic = mysqli_query($link,"SELECT COUNT(*) FROM `driver_details` WHERE status='1'");
       while($row = mysqli_fetch_array($pic)){
