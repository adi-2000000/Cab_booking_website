...
<body>
 <div class="container py-5">
        <div class="row mb-12">
            <div class="col-lg-12">
                <h4 class="display-4 font-weight-light text-center" style="color:#03a9f3;">Request B2B</h4>
...
if(isset($_POST['send_req'])){
 $b2bName = $_POST['b2b_name'];
 $b2bMail = $_POST['b2b_email'];
...
$message="<html>
            ...
            <div style='padding:50px;'>
                ...
                <p><strong>link:</strong> https://aimcabbooking.com/b2b/b2b-registration.php</p></br>
    ...
    ?>
     ...
     <script>window.alert("B2B Requested");</script>
...
?>
        ...
        <div class="row text-center" style="padding-top:20px;">
            <div class="col-xl-12 col-sm-6 mb-5">
                <form action="request-b2b.php" method="post" enctype="multipart/form-data" class="form-horizontal">


                    <div class="row form-group">
                        <div class="col col-md-2"><label for="text-input" class=" form-control-label">Vendor Name:</label></div>
                        <div class="col-12 col-md-8">
                            <input type="text" id="text-input" name="b2b_name" value="<?php echo $b2bDetails['b2b_name']; ?>"
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-8"><input type="text" id="text-input" name="b2b_email" value="<?php echo $b2bDetails['b2b_email']; ?>"
                                class="form-control"><small class="form-text text-muted"></small></div>
                                <div class="col-12 col-md-2"> </div>
                    </div>
