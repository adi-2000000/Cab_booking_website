...
//Cancellation mail to vendor
 ...
 $vedMail = $row['v_email'];
  ...
  $pic1 = mysqli_query($link,"SELECT * FROM `user_booking` WHERE `bookid` = '$bookid'");
...
$sql = "UPDATE `user_booking` SET vendorid='0', driverid='0', cabid='0', status='0' WHERE bookid='$bookid'";
