                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">All Outsource Cars Details</strong>&nbsp;<button class="button btn-add" data-toggle="modal" data-target="#myModal" ><i style="font-size:24px" class="fa">&#xf067;</i></button>
                            </div>
         ...
         <!--<div class="container">
                            ...
                            <div class="card-body card-block">
                                <form action="out-source-insert.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cars | Cabs No Plate</label></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="out-source.php"><button type="button" class="btn btn-warning">
                               <?php
                              include 'config.php';
                             ...
                             <span class="badge bg-dark"><?php echo $row['COUNT(*)']?></span> <?php }  ?>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                     <?php
                                      include 'config.php';
                                       $pic = mysqli_query($link,"SELECT * FROM `out_source_details` WHERE status = '1' ORDER BY `id` DESC");
                                       while($row = mysqli_fetch_array($pic)){
                                       ?> 
                                       <tr>
                                            ...
                                            <td>
                                                <form action="out-source.php" method="post">
