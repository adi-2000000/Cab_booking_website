...
<head>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAxVazjsriiPITKEJKHo_DvCIvt1-3Mb7s&libraries=places"></script>
        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $bookid = $_POST["bookid"];
                    $custquery = mysqli_query($link, "SELECT * FROM custom_booking WHERE bookid='$bookid'");
                    $row = mysqli_fetch_array($custquery);
                  ...
                  <option value="gst" <?php if($trip=="One Way" || $trip =="Round" || $trip=="Rental") echo 'selected="selected"'; ?> >GST</option>
                  <option value="nogst" <?php if($trip=="One Way NoGST" || $trip =="Round NoGST" || $trip=="Rental NoGST") echo 'selected="selected"'; ?> >WITHOUT GST</option>
                  </select>                       <br>
                     </div>    
                ...
                <div class="col-md-4 p-2"> 
                  ...
                  <option value="One Way NOGST" <?php if($trip =="One Way NoGST") echo 'selected="selected"'; ?> >One Way Trip</option>
                  <option value="Round NOGST" <?php if($trip =="Round NoGST") echo 'selected="selected"'; ?> >Round Trip</option>
                  <option value="Rental NOGST" <?php if($trip =="Rental NoGST") echo 'selected="selected"'; ?> >Rental Trip</option>
                  </select>
                   <br>
                  ...
                  <option value="One Way" <?php if($trip=="One Way") echo 'selected="selected"'; ?> >One Way Trip</option>
                  <option value="Round" <?php if($trip=="Round") echo 'selected="selected"'; ?> >Round Trip</option>
                  <option value="Rental" <?php if($trip=="Rental") echo 'selected="selected"'; ?> >Rental Trip</option>
                  </select>
                  <br>
                      <input id="bookid" class="form-control register_form " name="bookid" type="text" value="<?php echo $bookid;?>">  
                     </div>
                </div>
         
             <div class="rental">
                <form id="form" action="invoice-update.php" Method="POST" target="_blank">
                ...
                <form id="form" action="invoice-update.php" Method="POST" target="_blank">
                    ...
                    <div class="row p-2 my-1">
                         <div class="col-lg-4"><br>
                                <input id="bookid" class="form-control register_form " name="bookid" type="hidden" value="<?php echo $bookid;?>"> 
                                <strong class="label label-default">Vehicle Type :</strong>
                                <input id="car" class="form-control register_form " name="car" type="text" placeholder="Vehicle Type" value="<?php echo $car;?>" required><br>
                                <h4><strong><div class="text-dark my-1 ">Choose Date and Time</div></strong></h4> 
                                <input class="col-7" class="form-control register_form " name="date" type="date" value="<?php echo $date;?>" placeholder="Date"><br><br>
                                <input class="col-6" class="form-control register_form " name="time" type="text" value="<?php echo $time;?>" placeholder="Time"><br>
                                <input id="trip" class="form-control register_form " name="trip" type="hidden" value="One Way"><br>
                                <strong class="label label-default">Name :</strong>
                                <input id="name" class="form-control register_form " name="name" type="text" value="<?php echo $name;?>" placeholder="Name" required><br>
                                <strong class="label label-default">Contact :</strong>
                                <input name="phone" class="form-control register_form " type="text" value="<?php echo $phone;?>" placeholder="Phone Number" required><br>
                                <strong class="label label-default">Email :</strong>
                                <input id="email" class="form-control register_form " name="email" type="text" value="<?php echo $email;?>" placeholder="Email" required><br>
                                
                        </div>
                        
                        <div class="col-lg-4"><br>
                                <strong class="label label-default">PickUp Location :</strong>
                                <input id="pickup" class="form-control register_form " name="pickup" type="text" value="<?php echo $pickup;?>" placeholder="Pick Up Location" required><br>
                                <input id="origin" type="hidden" name="origin" required/>
                                <strong class="label label-default">Drop Location :</strong>
                                <input id="drop" class="form-control register_form " name="drop" type="text" value="<?php echo $drop;?>" placeholder="Drop Location" required><br>
                                <input id="destination" type="hidden" name="destination" required/>
                                <strong class="label label-default">Distance :</strong>
                                <input id="Distance" class="form-control register_form " name="distance" type="text" value="<?php echo $distance;?>" placeholder="Distance" required><br>
                                <strong class="label label-default">Amount :</strong>
                                <input id="amount" class="form-control register_form  " name="amount" type="text"  value="<?php echo $amount;?>" placeholder="Base Fare" oninput="myFunction()"><br>
                                <strong class="label label-default">Toll :</strong>
                                <input id="toll" class="form-control register_form  " name="toll" type="text" value="<?php echo $toll;?>" placeholder="Toll" oninput="myFunction()" ><br>
                                <strong class="label label-default">Parking :</strong>
                                <input id="parking" class="form-control register_form  " name="parking" type="text" value="<?php echo $parking;?>" placeholder="Parking" oninput="myFunction()" required><br>
                         </div>
                        
                        <div class="col-lg-4"><br>
                                
                                <strong class="label label-default">GST % :</strong>
                                <input id="gst1" class="form-control register_form " name="gst1" type="text"  placeholder="Enter GST %" oninput="gstFunction()"><br>
                                <input id="gst" class="form-control register_form " name="gst" type="text" value="<?php echo $gst;?>" placeholder="GST" readonly><br>
                                <strong class="label label-default">Service Charges % :</strong>
                                <input id="service1" class="form-control register_form " name="service1" type="text" placeholder="Enter Service Charge %" oninput="serviceFunction()"><br>
                                <input id="service" class="form-control register_form " name="service" type="text" value="<?php echo $service;?>" placeholder="Service Charge"  readonly><br>
                                <strong class="label label-default">SubTotal :</strong>
                                <input id="new_amount" class="form-control register_form " name="new_amount" type="text" value="<?php echo $new_amount;?>" placeholder="Subtotal" oninput="myFunction()" required><br>
                                <strong class="label label-default">Paid Amount :</strong>
                                <input id="totalpaid_amt" class="form-control register_form " name="totalpaid_amt" value="<?php echo $totalpaidAmt;?>" type="text" placeholder="Paid Amount" required><br>
                                <input id="submit" class="btn btn-warning p-1" title="Confirm here" type="submit" value="Submit" target="_blank"><br><br><br><br><br><br>
                                </form>
                        </div>
                </div>
                ...
                <form id="form" action="invoice-update.php" Method="POST" target="_blank">
                    ...
                    <div class="row p-2 my-1">
                         ...
                         <input id="bookid" class="form-control register_form " name="bookid" type="hidden" value="<?php echo $bookid;?>"> 
                                ...
                                <input class="col-7" class="form-control register_form " name="date" type="date" value="<?php echo $date;?>" placeholder="Date"><br><br>
                                <input class="col-6" class="form-control register_form " name="time" type="time" value="<?php echo $time;?>" placeholder="Time"><br><br>
                                <h4><strong><div class="text-dark my-1 ">Choose End Trip Date and Time</div></strong></h4>
                                 <input class="col-7" class="form-control register_form " name="dateend" type="date" value="<?php echo $dateend;?>" placeholder="Date"><br><br>
                                <input class="col-6" class="form-control register_form " name="timeend" type="time" value="<?php echo $timeend;?>" placeholder="Time"><br><br>
                                <strong class="label label-default">No. of Days :</strong>
                                <input id="days" class="form-control register_form " name="days" type="text" value="<?php echo $days;?>" placeholder="Days" required><br>
                                <strong class="label label-default">Vehicle Type :</strong>
                                <input id="car" class="form-control register_form " name="car" type="text" value="<?php echo $car;?>" placeholder="Vehicle Type" required>
                         ...
                         <div class="col-lg-4"><br>    
                                   <strong class="label label-default">Name :</strong>
                                    <input id="name" class="form-control register_form " name="name" type="text" value="<?php echo $name;?>" placeholder="Name" required><br>
                                    <strong class="label label-default">Contact :</strong>
                                    <input name="phone" class="form-control register_form " type="" value="<?php echo $phone;?>" placeholder="Phone Number" required><br>
                                    <strong class="label label-default">Email :</strong>
                                    <input id="email" class="form-control register_form " name="email" type="text" value="<?php echo $email;?>" placeholder="Email" required><br>
                                    <strong class="label label-default">PickUp Location :</strong>
                                    <input id="pickup" class="form-control register_form " name="pickup" type="text" value="<?php echo $pickup;?>" placeholder="Pick Up Location" required><br>
                                    ...
                                    <input id="Distance" class="form-control register_form " name="distance" type="text" value="<?php echo $distance;?>" placeholder="Distance" required><br>
                                    <strong class="label label-default">Amount :</strong>
                                    <input id="amount1" class="form-control register_form " name="amount" type="text" value="<?php echo $amount;?>" placeholder="Base Fare" oninput="myFunction1()" required><br>
                                    <strong class="label label-default">Driver Allowance :</strong>
                                    <input id="driver1" class="form-control register_form " name="driver" type="text" value="<?php echo $driver;?>" placeholder="Driver Allowance" oninput="myFunction1()" required><br>
                            
                        </div>
                        
                        <div class="col-lg-4"><br>
                                    <strong class="label label-default">Toll :</strong>
                                    <input id="toll1" class="form-control register_form " name="toll" type="text" placeholder="Toll" value="<?php echo $toll;?>" oninput="myFunction1()" required><br>
                                    <strong class="label label-default">Parking :</strong>
                                    <input id="parking1" class="form-control register_form " name="parking" type="text" value="<?php echo $parking;?>" placeholder="Parking" oninput="myFunction1()" required><br>
                                    <strong class="label label-default">GST % :</strong>
                                    <input id="gst3" class="form-control register_form " name="gst" type="text" placeholder="Enter GST %" oninput="gstFunction1()" required><br>
                                    <input id="gst2" class="form-control register_form " name="gst" type="text" value="<?php echo $gst;?>" placeholder="GST" readonly><br>
                                    <strong class="label label-default">Service Charges % :</strong>
                                    ...
                                    <input id="service2" class="form-control register_form " name="service" type="text" value="<?php echo $service;?>" placeholder="Service charge" readonly><br>
                                    <strong class="label label-default">SubTotal :</strong>
                                    <input id="new_amount1" class="form-control register_form " name="new_amount" type="text" value="<?php echo $new_amount;?>" placeholder="Subtotal" oninput="myFunction1()" required><br>
                                    <strong class="label label-default">Paid Amount :</strong>
                                    <input id="totalpaid_amt" class="form-control register_form " name="totalpaid_amt" type="text" value="<?php echo $totalpaidAmt;?>" placeholder="Paid Amount" required><br>
                                    <input id="submit" class="btn btn-warning p-1" title="Confirm here" type="submit" value="Submit" target="_blank"><br><br><br><br><br><br>
                                    </form>
                        </div>
 ...
 <script>
    $(function() {
        google.maps.event.addDomListener(window, 'load', function () {
            var from_places = new google.maps.places.Autocomplete(document.getElementById('pickup'));
            var to_places = new google.maps.places.Autocomplete(document.getElementById('drop'));
