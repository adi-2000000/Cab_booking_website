...
<div class="content">
                ...
                <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><i class="mr-2 menu-icon fa fa-car"></i>  Vehicle Details</strong>
                            </div>
    ...
    <div class="container">
                       <div class="row m-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 p-5 mr-5">
                                            <img src="cab/<?php echo $row['c_img']?>"
                                                alt="">
                                        </div> 
                                        <div class="row">
                                         <div class="col-md-4">
            ...
            Front
            <div class="img"><img src="cab/<?php echo $row['c_img_f']?>" alt="..." class="img-thumbnail"></div>
        </div>
                                            <div class="col-md-4">
            Side
            <div class="img"><img src="cab/<?php echo $row['c_img_s']?>" alt="..." class="img-thumbnail"></div>
        </div>
                                            <div class="col-md-4">
            Back
            <div class="img"><img src="cab/<?php echo $row['c_img_b']?>" alt="..." class="img-thumbnail"></div>
        </div>
        </div> <br>
        
                       <div class="row m-0 bg-light">
                                            <div class="col-md-6 col-6 ps-30 pe-0 my-4">
                                                <h4 class="text-muted">Car Type</h4>
                                            ...
                                            <div class="col-md-6 col-6 ps-30 my-4">
                                                <h4 class="text-muted">RC Number</h4>
        ...
        <div class="card mb-5">
          <div class="card-body">
            <div class="row">
              <div class="col-sm-4">
                <p class="mb-0">Car RC Number</p></p>
              </div>
              <div class="col-sm-4">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark" id="smallmodalLabel">RC Number</h5>
                            <img src="cab/<?php echo $row['c_img_rc']?>" >
...
<div class="modal fade" id="smallmodal1" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel1" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark" id="smallmodalLabel">Insurance</h5>
                            <img src="cab/<?php echo $row['c_insurance']?>" >
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal fade" id="smallmodal3" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel3" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark" id="smallmodalLabel">Permit</h5>
                              <img src="cab/<?php echo $row['c_permit']?>" >
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<!------Image-------Modal----->
            ...
            <div class="row">
              <div class="col-sm-4">
                <p class="mb-0">Fitness Certificate</p>
              </div>
               <div class="col-sm-4">
                <p class="text-muted mb-0"></p>
              </div>
...
<div class="modal fade" id="smallmodal2" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel2" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark" id="smallmodalLabel">Fitness Certificate</h5>
                              <img src="cab/<?php echo $row['c_fitness']?>" >
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <?php } ?>
                              <div class="row gx-5">
                                              ...
                                              include 'config.php';
                                               ...
                                               ?> 
                                                     <form action="approve-cab.php" method="POST">
                                                    <input type="hidden" name="cabid" value="<?php echo $cabid;?>">
                                                    <button type="submit" class="btn btn-success mr-3" title="Approved Cab">
                                                    Approve
                                                    </button>
                                                    </form>
                                               <?php 
                                              ...
                                              include 'config.php';
                                               ...
                                               ?> 
                                                      <form action="decline-cab.php" method="POST">
                                                     <input type="hidden" name="cabid" value="<?php echo $cabid;?>">
                                                     <button type="submit" class="btn btn-danger mr-3" title="Declined Cab">
                                                    Reject
                                                  </button>
                                                  </form>
                                               <?php 
