...
session_start();
include "config.php";
$sql = "UPDATE `queries` SET booking_details = 'visited' WHERE phone ='$_SESSION[phone]' ORDER BY id DESC LIMIT 1";
...
if($timeHrs >= $start && $timeHrs <= $end) {
 $nightCharge = 250;
  ...
  $new_amount1 = $service + $gst + $amount + $nightCharge;
...
<body>
    ...
    * {
    ...
    /* Center "Proceed to Pay" button for mobile view */
    .btn-primary {
       margin-left: 250px;
    }
  }
        ...
        <div class="row">
            ...
            <!-- First Card -->
                ...
                <div class="card1" style="margin: 20px; border: 1px solid #000;padding:10px">
                        ...
                        <div class="d-flex justify-content-between ">
                            <p class="textmuted">Distance</p>
                            <p class="fs-14 fw-bold"><b><?php echo $int?> KM</b></p>
                        </div>
            ...
            <div class="card1" style="margin: 20px; border: 1px solid #000;padding:10px">
                        <div class="d-flex justify-content-between ">
                            <p class="textmuted">Base Fare(Distance X RS)</p>
                            </p>
                    ...
                    if(isset($_POST['applycode'])){
                        ...
                        echo "<script>window.open('booking-details.php','_self') </script>"; 
                        ...
                        <div class="col-12 px-0">
                            <div class="row m-0">
                                <div class="col-12  mb-4 p-0">
                                    ...
                                    <center>   <button class="btn btn-primary" type="submit">Proceed to Pay</button> </center> 
                                        <?php
                                        $pic = mysqli_query($link,"SELECT * FROM `offer`");
                                        while($row = mysqli_fetch_array($pic)){
                                         $offer = $row['offer'];
