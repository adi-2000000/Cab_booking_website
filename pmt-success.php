...
$sql = "UPDATE `queries` SET payment_success = 'visited' bookid ='$bookid'";
  ...
  $sql1 ="UPDATE `user_booking` SET paid = '$new_amount' WHERE bookid ='$bookid'";
...
$sqlpay = "UPDATE `user_booking` SET payment = 'Successful' WHERE bookid ='$bookid";
  ...
  $sql2 ="UPDATE `custom_booking` SET paid='$new_amount1' WHERE bookid ='$bookid1'";
            ...
            <div style='padding:50px;'>
                <p>Hello Admin,<br>
                  <p>A customer just booked Cab! Please check these details- </p><br>
                         ...
                         <strong>Partial Amount - Rs.$rowfetch[offerpartial] </strong></p>
                         <br>
...
<body>
    ...
    <p>We have received your payment of Rs.' . $rowfetch[offeramount] . '.</p>
    ...
    <table style="width:100%" border="1" cellpadding="1" cellspacing="1"
        ...
        <tr>
                ...
                <td><strong>Rs.' . $rowfetch[offeramount] . ' </strong></td>
            </tr>
    </table>
...
<body>
    ...
    <table style="width:100%" border="1" cellpadding="1" cellspacing="1">
            ...
            <tr>
                <td><strong>DriverBhata(DriverBhata x days)</strong> </td>
...
<body>
    <p>Dear '.$rowfetch[name].',</p>
    <p>Thank you for choosing our Service ! We appreciate the apportunity to serve you.</p>
    <p>We have received your payment of Rs.' . $rowfetch[amount] . '.</p>
      <p>Your booking id is <strong>'.$bookid.'</strong></p>
    <p>Please see below for more details.</p>
    ...
    <table style="width:100%" border="1" cellpadding="1" cellspacing="1"
        ...
        <tr>
                <td><strong>Paid Amount:</strong></td>
                <td><strong>Rs.' . $rowfetch[amount] . ' </strong></td>
            </tr>
    </table>
    <p><strong>Note: If you have paid partial amount, the remainder should be paid after the trip is completed.</strong></p>
    <p>Regards<br />Team AimCab</p>
...
<?php include 'header.php';?>
      ...
      <div style="text-align:center;">
       <img src="images/successful_payment.png" alt="success" style="width:150px"/>
        ...
        <p style="text-align:center;">Your Booking is Confirmed<br/>Check your mail for more details</p>
        <br/>
